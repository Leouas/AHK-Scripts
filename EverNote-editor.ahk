...
{		
	...
	;颜色 字体格式等
	{
		...
		;常规标题设置
		!1::evernoteEditText("<h1 style='font-family:微软雅黑;margin: 10px 0 10px;padding: 0;font-weight: 700;cursor: text;position: relative;color:#00a82d;font-size:26px;color:#b45b3e;'>","</h1>")
		!2::evernoteEditText("<h2 style='font-family:微软雅黑;margin: 6px 0 10px;padding: 0;font-weight: 700;cursor: text;position: relative;color:#00a82d;font-size:22px;color:#b45b3e;'>","</h1>")
		!3::evernoteEditText("<h3 style='font-family:微软雅黑;margin: 6px 0 10px;padding: 0;font-weight: 700;cursor: text;position: relative;color:#00a82d;font-size:18px;color:#b45b3e;'>","</h1>")
		;引用
